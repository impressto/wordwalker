...
│       └── welcoming.png
└── objects/
    ├── la sandía.png          # Object images (named with Spanish text)
    ├── el plátano.png
    ├── la manzana.png
    └── ... (one per vocabulary item)
```
...
- Create remaining object images for all 10 food items:
  - ✅ la sandía.png (exists as per config)
  - ❌ el plátano.png
  - ❌ la manzana.png
  - ❌ la naranja.png
  - ❌ la piña.png
...
### Added Code
- `defaultCharacter`, `defaultEmotion` config properties
