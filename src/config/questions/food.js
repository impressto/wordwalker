...
// Fruits (20 questions)
  {
    ...
    hint: 'Sandía = watermelon. Mnemonic: think "sand" (beach) + -ía; word of Arabic origin from Moorish Spain.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'In Spain, "plátano" = banana; in many countries also "banana/banano". Plantain = "plátano macho". Mnemonic: think "plátano" → "plaid banana".',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Manzana = apple (feminine: la). Mnemonic: red/green like traffic lights. Note: en algunos países "manzana" también significa una cuadra (city block).',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Naranja = orange (fruit and color). Mnemonic: vitamin C → citrus → naranja.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'El vino se hace con uvas. España es el 3.º productor mundial de vino.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'En España: "melocotón". En gran parte de AL: "durazno". Ambos = peach.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Piña = pineapple. Cáscara con picos; pulpa amarilla y jugosa.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Kiwi: exterior marrón y peludo; interior verde con semillas negras.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Limón = cítrico ácido amarillo; en España "lima" es otro fruto.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Mango dulce con hueso grande; maduro = anaranjado.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Pera = forma de bombilla; textura suave y jugosa.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  ...
  },
  {
    ...
    hint: 'Arándano azul; en algunos países "arándano" puede ser rojo (cranberry).',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Melón (cantalupo o melón verde); más pequeño que la sandía, refrescante.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Tomate rojo: en ensaladas y salsa de tomate (kétchup, sofrito).',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Aceite de oliva viene de la aceituna. España produce ~40% del mundial.',
    points: 15,
    category: 'food',
    difficulty: 'hard',
  },
  {
    ...
    hint: 'Berenjena (eggplant). Etimología árabe: al-bāḏinjān (influencia morisca).',
    points: 15,
    category: 'food',
    difficulty: 'hard',
  },
  ...
  },
  {
    ...
    hint: 'Papa (patata en España) = tubérculo con almidón; base de las papas fritas.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  ...
  },
  {
    ...
    hint: 'Pepino verde y crujiente; alto contenido de agua, común en ensaladas.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  ...
  },
  {
    ...
    hint: 'Brócoli: floretes verdes como arbolitos; rico en fibra y vitaminas.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Pimiento morrón (bell pepper): rojo/verde/amarillo; sabor dulce, no picante.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  ...
  },
  {
    ...
    hint: 'Del cacahuate (maní). Es una legumbre que crece bajo tierra.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  ...
  // Main Dishes & Proteins (20 questions)
  {
    ...
    hint: 'Pizza: masa redonda con salsa de tomate, queso y toppings.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Hamburguesa: carne molida en pan, con queso/lechuga/tomate.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Hot dog (perro caliente): salchicha en pan largo, con salsas.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Taco: tortilla doblada con relleno (carne, pollo, verduras).',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Burrito: tortilla de harina grande enrollada con relleno.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Pita: pan plano con bolsillo para rellenar (falafel, carne, verduras).',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Sándwich (emparedado): ingredientes entre dos rebanadas de pan.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  {
    ...
    hint: 'Pollo: carne de ave más común; blanca y versátil en cocina.',
    points: 5,
    category: 'food',
    difficulty: 'easy',
  },
  ...
  },
  {
    ...
    hint: 'Taiwanese tea with tapioca pearls',
    points: 15,
    category: 'food',
    difficulty: 'hard',
  },
  ...
  // More International Dishes (15 questions)
  {
    ...
    hint: 'Onigiri = bola/triángulo de arroz con alga nori y relleno simple.',
    points: 15,
    category: 'food',
    difficulty: 'hard',
  },
  {
    ...
    hint: 'Senbei = galleta de arroz crujiente japonesa, a veces con salsa de soja.',
    points: 15,
    category: 'food',
    difficulty: 'hard',
  },
  {
    ...
    hint: 'Narutomaki = pasta de pescado con espiral rosa, típica en ramen.',
    points: 15,
    category: 'food',
    difficulty: 'hard',
  },
  {
    ...
    hint: 'Curry = salsa especiada. En la imagen con arroz (arroz con curry).',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Estofado = guiso lento en olla, con carne/verduras y caldo.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Fondue = queso derretido para mojar pan/verduras; plato suizo.',
    points: 15,
    category: 'food',
    difficulty: 'hard',
  },
  {
    ...
    correctAnswer: 'la paella',
    hint: 'Paella = arroz con azafrán y mariscos/carnes, típica de Valencia.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  ...
  },
  {
    ...
    hint: 'Ensalada César = lechuga + crutones + queso + aderezo con anchoa.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Hummus = puré de garbanzo con tahini, aceite de oliva y limón.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    hint: 'Taco duro = tortilla frita/crujiente con relleno dentro.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
  {
    ...
    correctAnswer: 'el falafel',
    hint: 'Falafel = croqueta de garbanzo/haba, frita; vegetariana.',
    points: 10,
    category: 'food',
    difficulty: 'medium',
  },
