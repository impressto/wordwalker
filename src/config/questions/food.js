...
export const foodQuestions = [
  ...
  },
  {
    ...
    options: ["la tarta", "el arroz", "el pescado"],
    correctAnswer: "la tarta",
    hint: 'Tart/Pie - sweet baked dessert with fruit',
    usageExample: "Sirvo la tarta caliente de manzana con helado de vainilla.",
    points: 10,
    category: "food",
    difficulty: "medium",
    emotion: "pleased",
